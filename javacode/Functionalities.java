...
* Código das funcionalidades de gerenciamento envolvendo banco de dados 
...
public class Functionalities {
  ...
  public static String addNotaForJson(Req req, Res res, Connection dbConnection) {
  ...
  public static String rmNotaForJson(Req req, Res res, Connection dbConnection) {
    /* Obtendo os dados para a busca e insercao */
    int RA = req.getRA();
    String discCode = req.getDiscCode();
    int ano = req.getAno();
  ...
  public static String listAlunosForJson(Req req, Res res, Connection dbConnection) {
